...
class UNET(chainer.Chain):
    ...
    def __init__(self, inputChannel=4, outputChannel=3):
        self._in = inputChannel
        self._out = outputChannel
        super(UNET, self).__init__(
            c0=L.Convolution2D(self._in, 32, 3, 1, 1),
            ...
            dc0=L.Convolution2D(64, self._out, 3, 1, 1),
...
class DIS(chainer.Chain):
    ...
    def __init__(self, inputChannel=3):
        ...
        super(DIS, self).__init__(
            c1=L.Convolution2D(self._in, 32, 4, 2, 1),
